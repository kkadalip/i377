...
public class Praks1yl3 extends HttpServlet {
	...
	//	   Vaadake, kuidas küsida kellaaega http://www.java-tips.org/java-se-tips/java.util/how-to-get-current-date-time.html
	//	   Graafika joonistamine: http://www.java2s.com/Code/Java/2D-Graphics-GUI/DrawanImageandsavetopng.htm
	//	   Faili kirjutamise asemel kirjutage väljundvoogu ( response.getOutputStream() )
	//	   Ärge unustage sättida õiget Content-Type-i
